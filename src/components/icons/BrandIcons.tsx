// lucide-react intentionally ships no brand/logo marks, so GitHub and
// LinkedIn are hand-rolled here as simple currentColor SVGs sized to
// match the surrounding lucide icons (h-4 w-4, h-5 w-5, etc).
